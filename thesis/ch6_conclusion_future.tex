...
Our evaluation shows that extending \texttt{MATCH\_RECOGNIZE} semantics
...
To ensure correctness, we validated our implementation against Trino
...
Finally, although our work emphasises correctness and modularity,
...
We presented a SQL-in-\texttt{pandas} engine for executing
...
By enabling SQL-native pattern recognition directly in Python, our
...
We plan to extend the engine along three complementary directions.
First, we will pursue \textbf{distributed execution} by enabling the
matcher to scale across multi-node environments with boundary-aware
state propagation, ensuring efficiency on large datasets.  Second, we
aim to develop a \textbf{backend abstraction layer} that targets
...
SQL systems.  Finally, we will invest in \textbf{tooling and adoption},
...
performance, and usability, broadening the impact of our approach.

By addressing the identified limitations and implementing the planned
enhancements, our goal is to develop a more adaptable and efficient
