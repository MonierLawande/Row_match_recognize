...
Table~\ref{tab:conc-claim-validation} lists the main claims of the
thesis, the evidence behind each, and the boundary within which it
holds.  The purpose is to keep every conclusion inside what the
