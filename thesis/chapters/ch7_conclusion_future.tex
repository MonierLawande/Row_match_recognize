...
technique.  Two sections do isolate a path:
Section~\ref{subsec:eval-ordering} forces the sort, and
Section~\ref{subsec:eval-worst-cases} uses a predicate the row-local
path cannot compile.  A full ablation, each technique alone and in
