...
match
(See Table~\ref{tab:sql-match-recognize-examples}).
...
the main benchmark.  The three systems are plotted on it (See
...
comparison (See Figure~\ref{fig:stress_memory}).  It places the engine's
cgroup incremental
