...
times over.  Exceeding either guard raises an explicit complexity
error.  Rows inside \texttt{\{-\ \ldots\ -\}} still take
...
Pandas DataFrame.  The SQL query is shown only as the upstream
