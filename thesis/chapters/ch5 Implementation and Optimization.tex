...
This section covers Stage~4 of
...
on a whole column at once instead of one row at a time.  Figure~\ref{fig:system-architecture}
shows the system boundary, while Figure~\ref{fig:exec-pipeline} expands
Stage~5 and shows the preceding planning and compilation stages.
...
Table~\ref{tab:perf-summary} gives their activation boundaries, and
each technique below carries the name used there.
