...
preserves the supported SQL:2016 behaviour while producing results
...
implementation details, and optimisation techniques.
...
This section examines exactly what must be parsed and what the output
...
handling, semantic validation, and logical-plan normalisation.  These
...
model, the concrete implementation components, and the optimisation
techniques used to improve runtime performance and memory behaviour.
