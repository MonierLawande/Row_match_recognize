...
implementation across five dimensions: output correctness (parity
with Trino), SQL:2016 feature coverage, row-pattern type coverage,
performance and scalability, and developer usability.
...
\begin{enumerate}
  ...
  \item \textbf{SQL:2016 feature coverage.}
    Compliance with key \texttt{MATCH\_RECOGNIZE} clauses is
    verified, including \texttt{PARTITION~BY}, \texttt{ORDER~BY},
  ...
  \item \textbf{Performance and scalability.}
    ...
    and pattern complexities to characterise how the engine scales
...
feature and the output matches Trino.
...
are used to characterise how the engine scales with data volume
