...
summarises the current limitations.  Section~\ref{sec:conclusion}
states the overall conclusion, and Section~\ref{sec:conc-future}
...
This chapter summarised the thesis findings and explained how the
proposed engine bridges SQL row-pattern recognition and Pandas-based
analytics.  It also identified limitations in complex-pattern
handling, user-defined aggregation, large-scale performance, memory
usage, and query-optimiser integration.

The chapter closed by outlining future work in distributed execution,
backend abstraction, and developer tooling.  These directions provide
a path for improving scalability, portability, and usability beyond
