...
Chapter~\ref{chap:methodology} describes the system design and
methodology, while Chapter~\ref{chap:implementation} presents the
implementation and optimisation techniques.  Chapter~\ref{chap:related}
surveys related work and identifies the research gap addressed by
this thesis.
